...
+----------------------------------------------------------------------+
|                                                                      |
|                SINE TABLE FOR DREDRUM PWM GENERATOR                  |
|                                                                      |
+----------------------------------------------------------------------+
|                     Copyright 2014 Jan Cumpelik                      |
|                                                                      |
| This table is free software: you can redistribute it and/or modify   |
...
| along with this table.  If not, see <http://www.gnu.org/licenses/>.  |
+----------------------------------------------------------------------+

*/
PROGMEM prog_char q_sine_table[] = { 
